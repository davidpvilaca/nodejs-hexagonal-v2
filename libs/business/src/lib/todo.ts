import { EClassError, throwCustomError } from '@nodejs-hexagonal-v2/utils'
import * as Joi from 'joi'
import * as R from 'ramda'
import { v4 as uuidv4 } from 'uuid'
import { CreateTodoInput, EPriority, ETodoStatus, MutateTodoInput, MutateTodoOutput, Todo } from '@nodejs-hexagonal-v2/models'
...
export const validateUpdateTodo = (data?: MutateTodoInput | null, originalData?: Todo | null, owner?: string): MutateTodoOutput => {
  ...
  return (['taskOwner', 'id', 'createdAt'] as Array<keyof Todo>)
    .reduce(
